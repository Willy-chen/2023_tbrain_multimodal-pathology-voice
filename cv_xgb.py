...
parser.add_argument('--public_feat', default='mel_8192_4096_128_cut_test_public.npy')
parser.add_argument('--public_data', default='public/test_datalist_public.csv')
parser.add_argument('--private_feat', default='mel_8192_4096_128_cut_test_private.npy')
